...
if (!document.getElementById(bootstrapCss))
{
    ...
    bootstrapWrapper.href = '../wp-content/plugins/countdown-maintenance-mode/css/bootstrap-wrapper.less';
    ...
    lessjs.src = '../wp-content/plugins/countdown-maintenance-mode/js/less.min.js';
    ...
    customStyles.href = '../wp-content/plugins/countdown-maintenance-mode/css/style-admin.css';
